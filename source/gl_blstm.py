...
## (1)impact of polarity and hydroph and position

## (2)full connect VS BLSTM
#   (2.1) test of full connect with different window size
#   (2.2) test of BLSTM with different window size
## (3)test of GL-BLSTM




##winSize is the length of the window size
## infoOfAA is the number of values we used to represent a residue.
## minimum of infoOfAA is 20 when only use pssm to represent a residue
## maximum of infoOfAA is 24 when pssm+position+polarity+hydrophobicity
